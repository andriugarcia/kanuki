<template lang="pug">
  #linechart.pa-3
    doughnut(v-if="this.content.Labels", :chartData="{labels: this.content.Labels, datasets: [{label: this.content.Label, backgroundColor: this.colors, data: this.content.Data}]}")
    div(v-if="edit")
